...
console.log(phones.mobile); // use .notation for a known property
console.log(phones["home"]); // use square brackets for the dictionary properties
...
numPair.length; //! ❌ DANGER ❌ It still shows that the length is 2 even though the array is empty

const roNumPair: readonly [number, number] = [4, 5]; // use readonly with tuples
roNumPair.length;
